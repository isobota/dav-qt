...
typedef struct _FILE_INFO
{
	...
	BYTE			image;					// Image		
	DHTIME			start_time;				// Start time	
	DHTIME			end_time;				// End time	
 ...
 * @param[in] nPitch range -50-50,0 means no change
 * @param[in] bQuick 0 means high quality use more CPU , 1 means slow quality use less CPU 
 * @return BOOL,TRUE--succeeded FALSE--failed.
 * @note if failed,you can get the error code by calling PLAY_GetLastErrorEx.
 */
